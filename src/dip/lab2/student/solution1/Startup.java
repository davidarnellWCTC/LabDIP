...
public class Startup {
    ...
    public static void main(String[] args) {
        TipCalculator calc1 = new BaggageTipCalculator(TipCalculator.ServiceQuality.GOOD, 5);
        calc1.setGoodRate(.25);
...
//        TipCalculator[] tippableService = {            
//            new FoodTipCalculator(TipCalculator.ServiceQuality.GOOD, 5),
//            new FoodTipCalculator(TipCalculator.ServiceQuality.GOOD, 5),
//            new FoodTipCalculator(TipCalculator.ServiceQuality.GOOD, 5),
//            new FoodTipCalculator(TipCalculator.ServiceQuality.GOOD, 5)
//        } ;
        ...
        double tip = ts.getTipAmount(calc1);
